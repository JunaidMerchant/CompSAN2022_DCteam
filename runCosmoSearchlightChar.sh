...
if [ ! -f /data/bswift-1/jmerch/CompSAN/searchlight/character_rsa/${Sub}_searchlight_socialnetwork.nii ]; then
...
# module load matlab
matlab -nodesktop -nodisplay -nosplash -r "cd /data/bswift-1/jmerch/CompSAN/code ; SearchlightRSA_Character $Sub ; quit"
